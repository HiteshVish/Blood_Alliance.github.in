    ...
    <main>
        <div class="container">
            <div class="contact-box">
                ...
                <form method="POST" action="blood_help.php">
                    <input type="text" name="Name" id="name" class="field" placeholder="Your Name">
                    <input type="text" name="E_Mail" id="E_mail" class="field" placeholder="Your Email">
                    <input type="text" name="Phone" id="Phone" class="field" placeholder="Phone">
