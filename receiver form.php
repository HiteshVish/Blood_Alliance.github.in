...
<header>
	<div class="container">
		<h1>Save Your life or Be Happy</h1>
		<form id="save" action="blood_receiver.php" method="post">
			...
			<div class="form-group">
				...
				<textarea id="Any_Disease_Questions" name="Any_Disease_Questions" rows="3"></textarea>
			</div>
			<div class="form-group">
				<label for="last-donation">Reason/Dr.Prescription:</label>
				<input type="file" id="Reason_Dr_Prescription" name="Reason_Dr_Prescription">
			</div><br><br>
